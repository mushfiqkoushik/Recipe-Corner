...
() {
  return (
        ...
        <section className="p-6 bg-emerald-500 dark:text-gray-50 mx-10">
	<form novalidate="" action="" className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full ">
					<label for="bio" className="text-sm">Please Write About Our Restuarant</label>
				...
				<div className="col-span-full">
					...
					<div className="flex items-center space-x-2">
						...
						<button type="button" className="px-4 py-2 border rounded-md dark:border-gray-100">SUBMIT</button>
					</div>
				</div>
			</div>
		</fieldset>
